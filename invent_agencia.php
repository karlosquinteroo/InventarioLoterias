...
<p>inventario por agencias</p>
</span>
</div>
</div>
<?php  
$query_inventario="select p070_tipo_articulo.tx_desc_tipo_articulo, m080_articulo.tx_descripcion_articulo, 
    m080_articulo.co_serial_articulo, m080_articulo.nu_precio, m080_articulo.nb_fabricante, m040_agencia.nb_agencia
    ...
    m040_agencia.co_agencia = '$agencia' ";
            ...
            <div class="container-fluid cont" style="margin-top: 1px; width: 250px;">
                <div class="row-fluid">
                    ...
                    <table class="table"  width="520" id="table" style="margin-left:0px; font-size:80%;">
                        ...
                        <?php $agencia_nb=$res_inventario[5];}?>
                    </table>
                    </div>
                    <span class="justificado">
                <p><?php if(isset($agencia_nb)){ echo $agencia_nb; } else { echo "No Hay articulos Asignados";}?></p>
                </span>
                </div>  
            </div>   
        </div>
