...
<head>
    ...
    <?php
        ...
        $sql_agencia=mysql_query("SELECT co_agencia, nb_agencia FROM `m040_agencia` where co_agencia = '$code' ; ")
        ...
        {  
            ...
            {
                $respuesta= "Debe seleccionar un articulo";
            }
            elseif( !isset( $_POST['cant']) )
            {
                $respuesta= "Debe señalar la cantidad";
            }
            elseif( !isset( $_POST["agencia_asignar"]) )
            {
                $respuesta= "Debe selecioar una agencia";
            }
        }
    ?>
</head>
...
<div style="float: right; position: fixed; margin-left: 76.8%; margin-top: 5.5%;">
<form id="form1" name="form1" method="post" action="">
    <label>agencia</label>
    <div class="input-control text" data-role="input-control">
        <select id="agencia_asignar" name="agencia_asignar" onchange="" style="width:125%;">
            <?php
...
<div class="container cont cent" style="margin-top:25px;">
    <div class="well" style="margin-top: 80px;">
        ...
        <h4>Asignar articulos</h4>
            ...
            <div style="float: right; position: fixed; margin-left: 69.5%; margin-top: 10%;">
                    <button class="btn btn-warning large btn btn-large"><a href="assign.php" >otra agencia </a></button>
                </div>
