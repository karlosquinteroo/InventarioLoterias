            ...
            <div class="container-fluid cont" style="margin-top: 5px; width: 250px;">
                    ...
                    <table class="table" id="table" width="900"style="margin-left:100px; ">
                        <tr>
                            ...
                            <th align="center">
                                <label>serial del articulo</label>
                                <div class="input-control text" data-role="input-control">
                                <input type="text" id="se_busqueda" name="se_busqueda" placeholder="Codigo del Articulo...">
                                </div>
                            </th>               
                            <th align="center">
                                <label>tipo de articulo</label>
                                <div class="input-control text" data-role="input-control">
                                <select id="tipo_buscar" name="tipo_buscar" onchange="tip(this)">
                            ...
                            <th align="center">
                                <label>estado </label>
                                <div class="input-control text" data-role="input-control">
                                <select id="estado_buscar" name="estado_buscar" onchange="edo(this)">
                                <option value="0">seleccione</option>
                                <?php
                        ...
                        <tr>
                            <th align="center">
                                <label>agencia</label>
                                <div class="input-control text" data-role="input-control">
                                <select id="agencia_buscar" name="agencia_buscar" onchange="ubi(this)">
                                <option value="0">seleccione</option>
                                <?php
                            ...
                            <th align="center">
                                ...
                                <button class="btn btn-warning btn-large" onclick="prueba()">buscar</button>
                                </div>
                            </th>
                        </tr>
                    </table>
