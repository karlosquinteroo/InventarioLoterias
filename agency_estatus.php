    ...
    <div class="container cont cent" style="margin-top:25px;">
        <div class="well" style="margin-top: 80px;">
            <div class="container-fluid cont" style="margin-top: 5px; width: 250px;">
                    <h4>detalle de agencias</h4>
                    <table class="table" id="table" width="900"style="margin-left:100px; ">   
                        <tr>
                            <th align="center">
                                <label>agencia</label>
                                <div class="input-control text" data-role="input-control">
                                <select id="agencia_detalle" name="agencia_detalle" onchange="ubi_1(this)" style="width:100%;">
                            ...
                            <th align="center">
                               <div style="">
                               <button class="btn btn-warning btn-large" onclick="go_asiga()">asignar articulos</button>
                               </div>
                            </th>
                        </tr>
                    </table>
