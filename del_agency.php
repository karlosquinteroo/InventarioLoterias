        ...
        $linbd=conectar(); 
            $query_inventario=" SELECT
                                ...
                                where 
                                    ...
                                    p030_municipio.co_estado = m020_estado.co_estado and
                                    m040_agencia.co_estado=1
                ...
                <div class="row-fluid">
                    ...
                    <table class="table" id="table" style="margin-left:0%; width:500%; font-size:90%; ">
                        <tr>
                            ...
                            <th align="center"> desincorporar </th> 
                        </tr>
                        ...
                        <tr>
                            ...
                            <td align="center"> <div style=""><button class="btn btn-small btn-warning" onclick="del_agency('<?php echo $res_inventario[0]; ?>')"> desincorporar </button></div></td>
                        </tr>
                        <?php }?>
                    </table>
                    </div>
